...
/*
 * Under this line, this file is a direct copy of ShiftPWM_Non_Blocking.ino.
 * To use this AVR project with your own files, just rename it from .ino to .cpp and add it to the project instead of this one.
 * You might have to add some function prototypes to the top of your file, because the Arduino environment does this automatically.
 */
